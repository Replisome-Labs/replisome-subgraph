...
import { handleCreated } from "../src/raster-metadata"
import { createCreatedEvent } from "./raster-metadata-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    let metadataId = BigInt.fromI32(234)
    let newCreatedEvent = createCreatedEvent(metadataId)
